...
## End-point: créer un aliment
Ajouter un aliment à la base de données
### Method: POST
>```
>http://localhost/IDAW/Projet/backend/aliments.php
>```
...
Mettre à jour un aliment de la base de donnée
### Method: PUT
>```
>http://localhost/IDAW/Projet/backend/aliments.php
>```
...
Supprimer un aliment de la base de données
### Method: DELETE
>```
>http://localhost/IDAW/Projet/backend/aliments.php
>```
...
Modifier la quantité d'un aliment dans un repas
### Method: PUT
>```
...
⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃
# 📁 Collection: CRUD journal 


## End-point: get meals between dates
Récupérer les repas d'un utilisateur entre deux dates
### Method: GET
>```
